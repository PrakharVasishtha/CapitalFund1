...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_role("textbox", name="Phone number or User ID").fill("MFB802RamRate$1")
    ...
    page.get_by_role("button", name="Login").click()
    page.get_by_role("button", name="Login").click()
    page.locator("#outer-base").click()
    page.get_by_role("textbox", name="Phone number or User ID").click()
    page.get_by_role("textbox", name="Phone number or User ID").fill("MFB802R1")
    page.get_by_role("textbox", name="Phone number or User ID").click()
    page.get_by_role("textbox", name="Phone number or User ID").fill("MFB802")
    page.get_by_role("button", name="Login").click()
    page.get_by_role("spinbutton", name="External TOTP").fill("348276")
    ...
    page1.get_by_role("textbox", name="Enter amount").click()
    page1.get_by_role("textbox", name="Enter amount").fill("1000")
